...
\subsection{GLOW}
GLOW \cite{gridworkshopweb, glowwebsite} is a University of Wisconsin grid used at the Madison campus to distribute 
...
\caption{Test test submission scripts} \label{fig:submission}
\end{figure}
