...
\subsection{GlideinWMS}
 The Glidein Workflow Management System \cite{sfiligoi2008glideinwms} is a job submission method that abstracts the grid interface, leaving only a batch system interface.  
