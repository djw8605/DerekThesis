...
During operation of the factory, it will submit glideins to the underlying batch system.  When these glideins report to the collector, the classads are copied by the factory to create OfflineAds.  
...
\end{tabular}
\caption{Changes to ClassAds for Offline function}
\end{table}
