...
Glidein jobs are compliment the job submission method and are used to present a transparent execution environment to the submitter.  
...
\section{OfflineAds} \label{sec:offlineads}
