...
In Figure \ref{fig:snapshothccgrid} you can see a snapshot of production jobs running on the HCC campus grid.  The first thing to notice is the total number of jobs running, (TODO: UPDATE WITH PICTURE).  This is larger than the total number of cores on the Nebraska campus. This particular picture, you can see many resources running jobs.  

\begin{itemize}
\item Local Resources: ff.unl.edu (prairiefire was full).
\item Peered campus resources: bluearc.rcac.purdue.edu, lustrea.rcac.purdue.edu, 
\end{itemize}
