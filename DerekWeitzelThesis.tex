...
\subsection{Condor}
Condor \cite{thain2005distributed} is a high throughput batch system developed at the University of Wisconsin - Madison.  

An important technology used in Condor is the ClassAd mechanism.  ClassAds are the language that Condor uses to communicate between daemons.  A ClassAd is a list of keys and values, where the values can be strings, numbers, or expressions.
