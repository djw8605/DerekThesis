...
The HCC Campus Grid differs from existing campus grid by building a expanding pool of resources for the users.  Other campus grids are limited to available resources on the campus or in a regional grid.  The HCC Campus Grid can transparently submit to increasing distant resources.  Figure \ref{fig:circleresources-intro} describes the widening available resources to users.  The HCC Campus Grid will first attempt to run at the local cluster, then campus clusters, and finally out to a national grid or other campus grids.
