...
Glideins are described in full in \cite{frey2002condor}.  The factory uses them on non-condor resources in order to create a virtual condor cluster that can successfully flock.
