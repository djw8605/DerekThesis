...
Prairiefire is setup to allow jobs from Firefly and the GlideWMS submit machine to run.  To do this, the configuration variable \texttt{FLOCK\_FROM} was set to \texttt{ff-grid.unl.edu, glidein.unl.edu}.
...
\subsection{Flock to Purdue Setup}
