...
The HCC campus grid is very resistant to failure due design decisions regarding the placement of the Campus Factory, especially when compared to the GlideinWMS Factory.
...
In Figure \ref{fig:snapshothccgrid} you can see a snapshot of production jobs running on the HCC campus grid.  The first thing to notice is the total number of jobs running, (7016).  This is larger than the total number of cores in any single Nebraska cluster, and almost as large as the total cores at Nebraska (8000). This particular picture, Derrick Stolee is running a graph search workflow.
...
Another interesting observation is that number of jobs running at the peered campus Purdue.   Purdue has large resources and peering with them have been very valuable to UNL researchers.
