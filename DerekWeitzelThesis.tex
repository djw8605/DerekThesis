...
\subsection{Condor}
Condor \cite{thain2005distributed} is a high--throughput batch computing system developed at the University of Wisconsin - Madison.  An overview from \cite{thain2005distributed}:
\begin{quotation}
